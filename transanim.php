...
.fa-instagram {
  ...
  width:20px;
		...
		<body>
						  ...
						  <ul><center>
							...
							<li><div class="CSS">CSS</div>
							  <ul class="dropdown">
								...
								<li><a href="canvas.php">Css Animation</a></li>
							  </ul>
							</li>
			...
			<div class="About me"><br><br><br><center><h2>Transitions<br>
				<a href="https://codepen.io/lizasetre/pen/QWNQYMp"><br>"https://codepen.io/lizasetre/pen/rNeJPdK"</a></div>
					
			<div class="About me"><br><br><br><center><h2>Animation<br>
				<a href="https://codepen.io/lizasetre/pen/QWNQYMp"><br>"https://codepen.io/lizasetre/pen/wvGyNxg"</a></div>		
					<div class="element">
					<div>
