...
.fa-instagram {
  ...
  width:20px;
		...
		<body>
			...
			<div class="About me"><br><br><br><center><h2>Graphical Arts using HTML5 Canvas<br>
			<a href="https://lizasetre.herokuapp.com/"><br>"https://asetreliz.herokuapp.com/"<br></a></div>
					<div>
